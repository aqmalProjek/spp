...
export default function EditDatasiswa({params}) {
  ...
  const getSiswaSingel = async() => {
    const res = await supabase.from("siswa").select().eq('nis',params.id).single();
    
    console.log(res);
    setNis(res.data.nis);
    setNamaSiswa(res.data.nama_siswa);
    setKodeKelas(res.data.kode_kelas);
    setAngkatan(res.data.angkatan);
    setNoSiswa(res.data.no_siswa);
    setAlamat(res.data.alamat);
    setJk(res.data.jenis_kelamin);
    setAgama(res.data.agama);
    setNamaWali(res.data.nama_wali);
    setNoWali(res.data.no_wali);
    setPekerjaan(res.data.pekerjaan);
    setEmail_wali(res.data.email_wali);
  }
  ...
  const simpansiswa = async (e) => {
    ...
    try {
      const res = await supabase.from("siswa").update({
        nis,
...
email_wali
  ...
  return (
    <div className="container">
      ...
      <button className="btn btn-primary " onClick={simpansiswa}>
        Simpan siswa
      </button>
